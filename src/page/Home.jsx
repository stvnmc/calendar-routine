      ...
      <div className="third">
        ...
        <div className="cont-text">
          <div style={{ transform: `translate(-${style}%)` }}>
            <p>
              Welcome to Calendar Routine, the ideal tool to organize your daily
              life. You can easily add events and set routines for each day.
            </p>
            <p>
              Organize your time efficiently with Calendar Routine. Record your
              daily activities and establish routines to optimize your day.
            </p>
            <p>
